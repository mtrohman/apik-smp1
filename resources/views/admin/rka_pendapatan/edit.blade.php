                ...
                <div class="block-content">
                    ...
                    <form id="editForm" method="POST" action='{{ route("admin.rka-pendapatans.update", $rkaPendapatan->id) }}' enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control mono rupiah @error('title') is-invalid @enderror" id="nominal" name="nominal" placeholder="Masukkan Nominal" value="{{$rkaPendapatan->nominal}}">
