...
@section('title')
    {{ $title='Tambah Rekening Pengeluaran' }}
@endsection
        ...
        <div class="col-md-8">
            <div class="block block-themed">
                ...
                <div class="block-content">
                    ...
                    <form id="tambahForm" method="POST" action='{{ route("admin.rekening-pengeluarans.store") }}' enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('kode_rekening') is-invalid @enderror" id="kode_rekening" name="kode_rekening" placeholder="Masukkan Kode">
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('nama_rekening') is-invalid @enderror" id="nama_rekening" name="nama_rekening" placeholder="Masukkan Nama">
