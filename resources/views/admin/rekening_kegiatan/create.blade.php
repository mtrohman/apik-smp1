        ...
        <div class="col-md-8">
            <div class="block block-themed">
                ...
                <div class="block-content">
                    ...
                    <form id="tambahForm" method="POST" action='{{ route("admin.rekening-kegiatans.store") }}' enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    ...
                                    <label class="form-label" for="example-select2">Rekening</label>
                                    @error('rekening_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('kode_kegiatan') is-invalid @enderror" id="kode_kegiatan" name="kode_kegiatan" placeholder="Masukkan Kode">
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror" id="nama_kegiatan" name="nama_kegiatan" placeholder="Masukkan Nama">
                        ...
                        <div class="row">
                            <div class="mb-4">
                                <div class="form-floating">
                                    <textarea class="form-control @error('ket_kegiatan') is-invalid @enderror" id="ket_kegiatan" name="ket_kegiatan" placeholder="Masukkan Keterangan" style="height: 100px"></textarea>
