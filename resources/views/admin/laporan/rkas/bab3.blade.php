        ...
        <div class="col-md-6">
            <div class="block block-themed">
                ...
                <div class="block-content">
                    ...
                    <form id="laporan" method="POST" action='{{ route("admin.proses.rkas_bab3") }}' enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="mb-4">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light text-end">
                    <button form="laporan" type="submit" formtarget="_blank" formaction="{{ route('admin.proses.rkas_bab3', ['preview'=> 'true']) }}" class="btn btn-raised btn-sm btn-alt-primary mb-0">
